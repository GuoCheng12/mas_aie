...
def build_summary_payload(state: AieMasState, report_dir: Path) -> dict[str, object]:
    ...
    return {
        ...
        "coverage_debt_hypotheses": final_answer.get("coverage_debt_hypotheses"),
        "credible_alternative_hypotheses": final_answer.get("credible_alternative_hypotheses"),
        "hypothesis_screening_ledger": final_answer.get("hypothesis_screening_ledger"),
        ...
        "decision_gate_status": final_answer.get("decision_gate_status"),
        "pairwise_task_outcome": final_answer.get("pairwise_task_outcome"),
        "pairwise_resolution_mode": final_answer.get("pairwise_resolution_mode"),
        "pairwise_resolution_evidence_sources": final_answer.get("pairwise_resolution_evidence_sources"),
        "pairwise_resolution_summary": final_answer.get("pairwise_resolution_summary"),
        "planned_action_label": final_answer.get("planned_action_label"),
        "executed_action_labels": final_answer.get("executed_action_labels"),
        "executed_evidence_families": final_answer.get("executed_evidence_families"),
        "planner_context_budget_status": final_answer.get("planner_context_budget_status"),
        "planner_context_compaction_level": final_answer.get("planner_context_compaction_level"),
        "planner_context_estimated_tokens": final_answer.get("planner_context_estimated_tokens"),
        ...
        rounds.append(
            {
                ...
                "portfolio_screening_summary": entry.portfolio_screening_summary,
                "screening_focus_hypotheses": list(entry.screening_focus_hypotheses),
                "screening_focus_summary": entry.screening_focus_summary,
                "action_taken": entry.action_taken,
                "planner": {
                    "diagnosis_summary": entry.diagnosis_summary,
                ...
                "working_memory": {
                    ...
                    "pairwise_resolution_summary": entry.pairwise_resolution_summary,
